...
async function generateServiceFile(service, options) {
    ...
    await (0, internal_1.createFile)(serviceDir, 'service.ts', (0, generator_without_ts_morph_1.serviceFile)(service), createFileOptions);
}
...
async function generateSourcesForService(service, project, options) {
    ...
    if (options.packageJson) {
        filePromises.push((0, internal_1.createFile)(serviceDirPath, 'package.json', await (0, service_1.packageJson)({
    ...
    if ((0, generator_utils_1.hasEntities)(service)) {
        ...
        filePromises.push((0, file_generator_1.sourceFile)(serviceDir, 'BatchRequest', (0, batch_1.batchSourceFile)(service), createFileOptions));
    }
    service.entities.forEach(entity => {
        logger.verbose(`Generating entity: ${entity.className}...`);
        filePromises.push((0, file_generator_1.sourceFile)(serviceDir, entity.className, (0, entity_1.entitySourceFile)(entity, service), createFileOptions));
        filePromises.push((0, file_generator_1.sourceFile)(serviceDir, `${entity.className}RequestBuilder`, (0, generator_without_ts_morph_1.requestBuilderSourceFile)(entity, service.oDataVersion), createFileOptions));
    });
    service.enumTypes.forEach(enumType => {
        logger.verbose(`[${service.originalFileName}] Generating enum type ${enumType.originalName} ...`);
        filePromises.push((0, file_generator_1.sourceFile)(serviceDir, enumType.typeName, (0, enum_type_1.enumTypeSourceFile)(enumType), createFileOptions));
    });
    service.complexTypes.forEach(complexType => {
        ...
        filePromises.push((0, file_generator_1.sourceFile)(serviceDir, complexType.typeName, (0, complex_type_1.complexTypeSourceFile)(complexType, service.oDataVersion), createFileOptions));
    });
    ...
    if (service.operations.length) {
        ...
        filePromises.push((0, file_generator_1.sourceFile)(serviceDir, 'operations', (0, operations_1.operationsSourceFile)(service), createFileOptions));
    }
    filePromises.push((0, file_generator_1.sourceFile)(serviceDir, 'index', (0, service_1.indexFile)(service), createFileOptions));
    if (options.readme) {
        logger.verbose(`[${service.originalFileName}] Generating readme ...`);
        filePromises.push((0, internal_1.createFile)(serviceDirPath, 'README.md', (0, service_1.readme)(service), createFileOptions));
    }
    if (options.metadata) {
