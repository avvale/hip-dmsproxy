...
exports.ODataBoundActionImportRequestConfig = exports.ODataBoundActionRequestConfig = void 0;
 ...
 */
class ODataBoundActionImportRequestConfig extends ODataBoundActionRequestConfig {
    constructor(
    /**
     * @deprecated Since 3.3.0. This parameter is unused and will be removed in the next major release.
     */
    method, entityApi, actionName, parameters, oDataUri) {
        super(entityApi, actionName, parameters, oDataUri);
        this.entityApi = entityApi;
        this.oDataUri = oDataUri;
    }
}
exports.ODataBoundActionImportRequestConfig = ODataBoundActionImportRequestConfig;
