...
import type { ODataRequestConfig, BatchReference, WithBatchReference } from '../request';
...
export declare abstract class OperationRequestBuilderBase<DeSerializersT extends DeSerializers, ReturnT, RequestConfigT extends ODataRequestConfig> extends MethodRequestBuilder<RequestConfigT> implements WithBatchReference {
     ...
     */
    protected constructor(responseTransformer: (data: any) => ReturnT, requestConfig: RequestConfigT, _deSerializers: DeSerializersT);
    /**
     * Execute request.
     ...
     */
    execute(destination: HttpDestinationOrFetchOptions, dataAccessor?: (data: any) => any): Promise<ReturnT>;
    /**
 ...
 */
export declare const ActionFunctionImportRequestBuilderBase: typeof OperationRequestBuilderBase;
